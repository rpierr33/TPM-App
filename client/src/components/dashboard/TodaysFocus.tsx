    ...
    <div className="space-y-4 mb-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-[10px] text-gray-400">Your personalized daily view</p>
          </div>
        </div>
        <button
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
                  ...
                  {briefing.recommendations && briefing.recommendations.length > 0 && (
                    <div className="space-y-1 pt-2 border-t border-gray-100">
                      ...
                      {briefing.recommendations.slice(0, 3).map((r, i) => (
                        <p key={i} className="text-[11px] text-gray-500 leading-relaxed pl-1">• {r}</p>
                      ))}
                    </div>
                  )}
                </div>
        ...
        {dashboardPrefs.showUrgencyStats && (
          <div className={`space-y-3 ${!dashboardPrefs.showAIBriefing ? 'lg:col-span-3 grid grid-cols-3 gap-3 space-y-0' : ''}`}>
