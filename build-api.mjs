...
execSync(
  "npx esbuild server/api-entry.ts --bundle --platform=node --format=cjs --outfile=.vercel/output/functions/api.func/index.js --external:bufferutil --external:utf-8-validate",
  { stdio: "inherit" }
);
